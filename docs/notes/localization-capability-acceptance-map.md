...
| N3 5+ tracking | AS-9 guard | **pinned** | 5-walker run is stability-only: bounded blob count, no crash, 5 distinct blobs never asserted (measured median 2.0, max 3 = logged undercount; spaxel-92ce3d2a; re-run at HEAD e8c3399d: median 2.0, max 4, ceiling 20 — spaxel-5a9bd318) |
